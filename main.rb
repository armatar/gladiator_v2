...
character1 = RandomCharacterFactory.randomize(1, 'PC')
character2 = RandomCharacterFactory.randomize(1, 'Ally 1')
character3 = RandomCharacterFactory.randomize(1, 'Enemy 1')
character4 = RandomCharacterFactory.randomize(1, 'Enemy 2')
